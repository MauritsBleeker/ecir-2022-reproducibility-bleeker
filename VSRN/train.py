...
def main():
    ...
    parser.add_argument('--experiment_name', default='paper_experiment_vsrn',
    ...
    if torch.cuda.is_available():
        dir = '/ivi/ilps/personal/mbleeke1/mmc_reproduce/vsrn'
    else:
        dir = '.'

    wandb.init(project='vsrn_paper_experiments', entity='mbleeker', tags=["vsrn", "papers_experiments_vsrn"],
               name=opt.experiment_name, dir=dir)
